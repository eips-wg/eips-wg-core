...
Introduce code validation at contract creation time for EOF formatted ([EIP-3540](https://eips.fyi/3540))
...
*Remark:* We rely on the notation of *initcode*, *code* and *creation* as defined by [EIP-3540](https://eips.fyi/3540).
...
See [Security Considerations of EIP-3540](https://eips.fyi/3540#security-considerations).
