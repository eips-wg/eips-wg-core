...
`EXTCODEHASH` was introduced in Constantinople, with [EIP-1052](https://eips.fyi/1052). It was priced at `400` with the reasoning:
...
- Contracts that assume a certain fixed gas cost for calls (or internal sections) may cease to function.
  - A fixed gas cost is specified in [ERC-165](https://eips.fyi/165) and implementations of this interface do use the affected opcodes.
