...
A notable example would be when a validator want to act as an [EIP-1077](https://eips.fyi/1077) Gas Relayer, incentivized to pick up fees from meta transactions.
