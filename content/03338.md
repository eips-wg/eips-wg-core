...
status: Withdrawn
withdrawal-reason: Withdrawn in favor of [EIP-2681](https://eips.fyi/2681)
...
This mode of replay protection is out of fashion since [EIP-155](https://eips.fyi/155) introduced a more elegant way using chain identifiers.
