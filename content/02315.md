...
It depends on the two new opcodes proposed by [EIP-4200](https://eips.fyi/4200) to support static jumps:
...
In concert with [EIP-3540](https://eips.fyi/3540) and [EIP-3670](https://eips.fyi/3670) it ensures, at initialization time, that valid code will not execute invalid instructions or jump to invalid locations, will not underflow stack, will maintain consistent numbers of inputs and outputs for subroutines, and will have bounded stack height in the absence of recursion.
