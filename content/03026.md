...
This EIP is based on and tends to replace matter-labs' proposol for significant performance reasons. In most applications, BW6-761 is used as an outer curve to BLS12-377 considered in [EIP-2539](https://eips.fyi/2539).
...
Gas costs are based on [EIP-1962](https://eips.fyi/1962) estimation strategy (but do not fully include yet parsing of ABI, decoding and encoding of the result as a byte array).
