...
operations by 69k gas. However, in light of proposal in [EIP-2028](https://eips.fyi/2028), the increase can be made much smaller.
...
## Rationale
[EIP-1884](https://eips.fyi/1884) seeks to increase the gas cost of `SLOAD` but using a different justification
...
[EIP-2028](https://eips.fyi/2028) describes the model that can be used for deciding the gas cost of data transmission. It is relevant
...
[EIP-2026](https://eips.fyi/2026) (rent prepayment for accounts), the recommendation will be made to raise the gas limit. This can somewhat dampen the
