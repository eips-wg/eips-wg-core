...
This EIP *ideally* requires that `MODEXP` repricing is [implemented](https://eips.fyi/2565) to also accurately reflect that there is no implicit compensation for an old `STATICCALL (0xfa)` cost (pre-2046).
