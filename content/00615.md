...
> **[EIP-1702](https://eips.fyi/1702). Generalized Account Versioning Scheme.** This proposal needs a versioning scheme to allow for its bytecode (and eventually eWasm bytecode) to be deployed with existing bytecode on the same blockchain.
...
Regardless, we will need a versioning scheme like [EIP-1702](https://eips.fyi/1702) to allow current code and EIP-615 code to coexist on the same blockchain.
