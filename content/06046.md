...
1. Change the rules introduced by [EIP-2681](https://eips.fyi/2681) such that regular nonce increase is bound by `2^64-2` instead of `2^64-1`. This applies from genesis.
