...
| [`TRANSACTION_TYPE_SSZ`](https://eips.fyi/6493#eip-2718-transaction-types) | `0x04` |
...
A typed withdrawal envelope similar to [EIP-2718](https://eips.fyi/2718) is introduced for exchanging withdrawals via the [Ethereum Wire Protocol](https://github.com/ethereum/devp2p/blob/6b259a7003b4bfb18365ba690f4b00ba8a26393b/caps/eth.md).

```
withdrawal = {legacy-withdrawal, typed-withdrawal}
```

Untyped, legacy withdrawals are given as an RLP list as defined in [EIP-4895](https://eips.fyi/4895).
