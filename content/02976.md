...
## Abstract
[Typed Transactions](https://eips.fyi/2718) can be sent over devp2p as `TransactionType || TransactionPayload`.
...
## Motivation
[EIP-2718](https://eips.fyi/2718) introduced new transaction types for blocks (which presents itself in the makeup of a block header's transaction root and receipts root).
...
*Note: See [EIP-2718](https://eips.fyi/2718) for additional motivations of Typed Transactions.*
