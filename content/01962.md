...
This proposal is an extension and formalization of [EIP-1829](https://eips.fyi/1829) with an inclusion of pairings. [EIP-1109](https://eips.fyi/1109) is required due to low cost of some operations compared to the `STATICCALL` opcode (more information in the corresponding section below).
...
- There is a pending proposal to implement base elliptic curve arithmetic is covered by [EIP-1829](https://eips.fyi/1829) and will allow to implement various privacy-preserving protocols with a reasonable gas costs per operation.
...
Functionality of this newly proposed precompile is different from [EIP-1829](https://eips.fyi/1829) in the following aspects:
