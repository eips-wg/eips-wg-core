...
The precompile's `input` is the tightly packed concatenation of the following fields:
  ...
  * `version` (1 byte) specifies which version of the stateless proof verification function should be used. Version 0 is used for an MPT and version 1 is used for the polynomial commitment scheme multiproof used in [EIP-6800](https://eips.fyi/6800).
