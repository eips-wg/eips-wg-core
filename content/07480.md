...
We introduce four new instructions on the same block number [EIP-3540](https://eips.fyi/3540) is activated on:
...
We extend code section validation rules (as defined in [EIP-3670](https://eips.fyi/3670)).
