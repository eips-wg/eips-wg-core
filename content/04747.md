...
Simplify the definition of [EIP-161](https://eips.fyi/161), removing the requirement for implementors to support edge cases that are impossible on Ethereum Mainnet.
