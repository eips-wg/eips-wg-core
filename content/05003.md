...
This EIP introduces a new opcode, `AUTHUSURP`, which deploys code at an [EIP-3074](https://eips.fyi/3074) authorized address. For externally owned accounts (EOAs), together with [EIP-3607](https://eips.fyi/3607), this effectively revokes the original signing key's authority.
