...
We introduce three new instructions on the same block number [EIP-3540](https://eips.fyi/3540) is activated on:
...
Given `MAX_CODE_SIZE = 24576` (in [EIP-170](https://eips.fyi/170)) and `MAX_INITCODE_SIZE = 49152` (in [EIP-3860](https://eips.fyi/3860)), we think the 16-bit immediate is large enough.
