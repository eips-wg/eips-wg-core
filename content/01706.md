...
status: Withdrawn
withdrawal-reason: The authors prefer [EIP-2200](https://eips.fyi/2200)
...
## Abstract
[EIP-1283](https://eips.fyi/1283) significantly lowers the gas costs of writing to contract's storage. This created a danger of a new kind of reentrancy attacks on existing contracts as Solidity by default grants a 'stipend' of 2300 gas to simple transfer calls.
