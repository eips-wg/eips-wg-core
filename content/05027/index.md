...
Only contracts deployed before [EIP-170](https://eips.fyi/170) could possibly be longer than the current max code size, and the reference implementation was able to successfully import all blocks before that fork.
